(function() {
  ...
  if (!(typeof exports !== "undefined" && exports !== null ? exports : this).Spine) {
    (typeof exports !== "undefined" && exports !== null ? exports : this).$ = require('spine');
  }
  ...
  $(function() {
    return $('body').bind('touchstart', function(e) {
      ...
      touch.last = now;
      return $(touch.target).trigger('touch');
  ...
  if ($.support.touch) {
    ...
    $(function() {
      return $('body').bind('click', function(e) {
        return $(e.target).trigger('touch').trigger('tap');
      });
    });
  }

  types = ['swipe', 'swipeLeft', 'swipeRight', 'swipeUp', 'swipeDown', 'touch', 'tap'];
